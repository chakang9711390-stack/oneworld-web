  ...
  return (
    <form className="grid gap-6" onSubmit={handleSubmit}>
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <SelectField label="职业" value={form.roleId} onChange={(value) => setForm((prev) => ({ ...prev, roleId: value }))} options={roles} />
        <SelectField label="工作流" value={form.workflowTemplateId} onChange={(value) => setForm((prev) => ({ ...prev, workflowTemplateId: value }))} options={workflows} />
