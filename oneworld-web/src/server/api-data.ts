...
export const opcProjects = [
  { title: '创建我的 OPC', slug: 'create-my-opc', description: '从当前行业出发，创建属于我自己的 OPC 项目结构。', status: '创建入口' },
  { title: '知识 IP 变现型 OPC', slug: 'knowledge-ip-opc', description: '通过内容输出、知识产品和私域承接形成持续变现闭环。', status: '案例卡片' },
  { title: '高客单咨询成交型 OPC', slug: 'high-ticket-consulting-opc', description: '围绕认知输出、咨询诊断与方案交付构建成交路径。', status: '案例卡片' },
] as const;
...
export const workflowScenes = [
  { title: '生成我的工作流', slug: 'generate-my-workflow', description: '根据当前行业与职位，生成适合我的专属工作流结构。', status: '生成入口' },
  { title: '需求澄清', slug: 'requirement-clarification', description: '用于整理需求背景、目标、约束条件与关键决策问题。', status: '场景卡片' },
  { title: 'PRD 生成', slug: 'prd-generation', description: '基于已有输入快速生成结构化 PRD 初稿与核心模块内容。', status: '场景卡片' },
  { title: '开发拆解', slug: 'development-breakdown', description: '把需求转化为研发可执行的任务拆解、模块分工与优先级。', status: '场景卡片' },
] as const;
...
export const workspaceOverview = {
  ...
  workflowCount: 5,
  projectCount: 3,
  opcSummary: '1 个在推进，1 个待补内容',
  workflowSummary: '最近 7 天被调用 5 次',
  projectSummary: '2 个进行中，1 个待启动',
} as const;
